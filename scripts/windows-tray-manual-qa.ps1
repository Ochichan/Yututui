...
try {
    ...
    Ask-Check -Key "background_starts_tray_only" -Prompt "The --background launch shows only the notification icon (no Mini Player window)"
    ...
    Ask-Check -Key "secondary_background_raises_no_window" -Prompt "The secondary --background invocation exits without raising the Mini Player"
