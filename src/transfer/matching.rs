...
pub(crate) use crate::track_identity::strip_annotations;
use crate::track_identity::strip_video_noise;
pub use crate::track_identity::{normalize, normalize_stripped, similarity};
