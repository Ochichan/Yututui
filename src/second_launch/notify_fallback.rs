...
mod tests {
    ...
    #[test]
    fn body_names_the_terminal_in_all_languages() {
        ...
        for (lang, expect) in [
            ...
            (crate::i18n::Language::Japanese, "WezTermで実行中です。"),
        ] {
