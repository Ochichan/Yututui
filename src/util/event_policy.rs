...
pub enum EventKey {
    ...
    MouseMove,
    PlayerAudioDevice,
    PlayerAudioDeviceList,
    PlayerAudioCodec,
    PlayerCacheTime,
    PlayerChapters,
    PlayerCurrentAudioOutput,
    PlayerDuration,
    PlayerFileFormat,
    PlayerMetadata,
    PlayerPaused,
...
impl EventKey {
    pub const fn name(self) -> &'static str {
        match self {
            ...
            EventKey::MouseMove => "mouse.move",
            EventKey::PlayerAudioDevice => "player.audio_device",
            EventKey::PlayerAudioDeviceList => "player.audio_device_list",
            EventKey::PlayerAudioCodec => "player.audio_codec",
            EventKey::PlayerCacheTime => "player.cache_time",
            EventKey::PlayerChapters => "player.chapters",
            EventKey::PlayerCurrentAudioOutput => "player.current_audio_output",
