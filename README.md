...
YouTube Music in your terminal. Fast, keyboard-driven, no browser tab eating your RAM, no ads. AI radio, real album art, and remote control — all from a three-letter command: `ytt`.
...
| `f` | Favorite / rate |
| `d` | Download |
| `Ctrl+R` | Toggle AI radio |
| `Shift+L` | Lyrics |
| `a` | AI assistant |
| `w` | Why the AI picked these |
| `,` | Settings |
...
| AI won't respond | Add a free Gemini key in Settings → AI and switch **Enable AI** on. |
